...
------------------------------------------------------------------------------------------------ */
// Cait Rowland helped me figure out I need to have the || [] in the return statement
const isCapitalized = (str) => {
  return str.match(/\w*[A-Z]\w*/gm) || [];
}
...
------------------------------------------------------------------------------------------------ */
// Cait Rowland helped me with this one too! Had to put [Oo] in the brackets
const matchMonth = (word) => {
  // Solution code here...
  return /\b[Oo]ct(?:ober)?\b/gm.test(word);
};
...
const noPunctuation = str => {
  // Solution code here...
  return str.match(/\w*[a-z0-9A-Z]\w* /gm);
};
...
const findShells = (str) => {
  // Solution code here...
  return str.match(/\b\w*ells\b/gm);
};
